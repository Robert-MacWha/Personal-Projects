...
public void draw() {
    ...
    translate(100, 100);
    netA.render_Summary(20, 4, 50, 150, 5, 0.018f);
    ...
    translate(300, 100);
    netB.render_Summary(20, 4, 50, 150, 5, 0.018f);
    ...
    translate(500, 100);
    netC.render_Summary(20, 4, 50, 150, 5, 0.018f);
    ...
    translate(700, 100);
    netD.render_Summary(20, 4, 50, 150, 0.1f, 0.018f);
...
static float weight_mutation_factor = 0.5f;
...
class Network {
    ...
    Network (Network p1, Network p2) {
        ...
        for(Connection c : p1.connections) {
            ...
            if (p2_connection_index != -1 && random(1) <= 0.5f) 
    ...
    public void add_Node (int c_index) {
    ...
    public void mutate_Random_Weight () {
...
class Node {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "NEAT" };
    if (passedArgs != null) {
