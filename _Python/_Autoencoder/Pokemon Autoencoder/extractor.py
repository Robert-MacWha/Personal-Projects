...
IMAGE_DIRs = glob.glob("pokemon/pokemon_augmented/*.jpg")
# Directory the final .npy file will be saved to
OUTPUT_DIR = "dataset-pokemon-128.max.npy"
# number of images
NUM_IMAGES = 4094
...
images = np.empty((NUM_IMAGES, IMAGE_DIM[1], IMAGE_DIM[0], IMAGE_DIM[2]))
