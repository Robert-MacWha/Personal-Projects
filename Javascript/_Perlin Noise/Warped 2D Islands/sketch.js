...
function setup() {
  ...
  warpButton.position(20, height + 120);
  ...
  wFrequencySlider = createSlider(0, 0.1, 0.08, 0.001);
  wFrequencySlider.position(20, height + 150);
  let wFrequencyLable = createP('- Warped Frequency');
  wFrequencyLable.position(160, height + 135);
  
  wAmplitudeSlider = createSlider(0, 50, 40, 0.01);
  wAmplitudeSlider.position(20, height + 180);
  let wAmplitudeLable = createP('- Warped Amplitude');
  wAmplitudeLable.position(160, height + 165);
}
